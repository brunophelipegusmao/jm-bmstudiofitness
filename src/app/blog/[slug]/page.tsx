    ...
    return (
      <div className="min-h-screen bg-black text-white">
        ...
        <section className="pb-16">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <article className="prose prose-lg prose-invert prose-headings:text-white prose-p:text-slate-300 prose-strong:text-white prose-em:text-slate-300 prose-a:text-[#C2A537] prose-a:no-underline hover:prose-a:underline prose-blockquote:border-l-[#C2A537] prose-blockquote:text-slate-300 prose-code:text-[#C2A537] prose-code:bg-slate-900 prose-code:px-1 prose-code:py-0.5 prose-code:rounded prose-pre:bg-slate-900 prose-pre:border prose-pre:border-slate-800 prose-ul:text-slate-300 prose-ol:text-slate-300 prose-li:text-slate-300 prose-img:rounded-lg max-w-none">
              <ReactMarkdown
